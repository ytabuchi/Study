...
namespace Cons_IJsonData
{
    class Program
    {
        const string ConnpassJsonUrl = "https://raw.githubusercontent.com/ytabuchi/Study/master/Cons_IJsonData/Cons_IJsonData/ConnpassJson.json";
        const string rawConnpassJson = @"
...
";
        const string AtndJson = "https://raw.githubusercontent.com/ytabuchi/Study/master/Cons_IJsonData/Cons_IJsonData/AtndJson.json";
        const string rawAtndJson = @"
...
";
        ...
        static void Main(string[] args)
        {
            ...
            //var data1 = JsonConvert.DeserializeObject<ConnpassJson>(rawConnpassJson);
    ...
    class ConnpassLoader : ILoader
    {
        public async Task<IEnumerable<IData>> LoadAsync(string url)
        {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    using (var stream = await response.Content.ReadAsStreamAsync())
                    {
                        using (var streamReader = new StreamReader(stream))
                        {
                            ...
                            var res = JsonConvert.DeserializeObject<List<IData>>(
            ...
            //var data = JsonConvert.DeserializeObject<ConnpassJson>(Program.connpassJson);
